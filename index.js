...
function appendKitten(name) {var newKittens = kittens.append(name);
  return newKittens;
}

var kittens = ['Milo', 'Otis', 'Garfield']

function prependKitten(name) {var newKittens = kittens.prepend(name);}

var kittens = ['Milo', 'Otis', 'Garfield']

function removeLastKitten() {var newKittens = kittens.slice(0, -1);}
